...
你可以自由地从 Python 官方网点: http://www.python.org，以源代码或二进制形式获取 Python 解释器以及其标准扩展库，
...
如果需要了解相关标准库或对象的详细介绍，请查阅 `Python 参考文档`_ 。`Python 参考手册`_ 提供了更多语言相关的正式说明。
如果想要使用 C 或 C++ 编写扩展，请查阅 `Python 解释器扩展和集成章节`_ 和 `C API 参考手册`_ 。
